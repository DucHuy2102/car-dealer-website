...
const SubscribeButton = () => {
    ...
    return (
        <Button disabled={pending} type='submit' className='uppercase font-bold w-full'>
            {pending ? (
...
export default function NewsletterForm() {
    ...
    return (
        <div className='space-y-4'>
            ...
            <p className='text-gray-700'>Enter your details to receive new stock notifications.</p>
            <Form {...form}>
                <form
                    ref={formRef}
                    className='space-y-2'
